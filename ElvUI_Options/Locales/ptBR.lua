...
L["Add an aura to the filter. Aura IDs can be acquired using the tooltip to find the correct ID."] =
	"Adicionar uma aura ao filtro. Números de identificação (IDs) podem ser adquiridos usando o tooltip para encontrar o ID correto."
L["Primary Unit"] = "Unidade Primária"
L["Requires the unit to be the primary target to display."] =
	"Requer que a unidade seja o alvo primario para ser exibido."
...
L["Use the profile specific filter Aura Indicator (Pet) instead of the global filter Aura Indicator."] =
	"Use o filtro especifico de perfil Aura Indicator (Pet) ao invés do filtro global Aura Indicator."
...
L["Add an Item by dragging it, shift-clicking, or entering the Item ID onto this field."] =
	"Adicione um Item arrastando-o, shift+clique esquerdo, ou digitando o ID de Item neste campo."
...
L["Adds an arrow infront of the chat lines to copy the entire line."] =
	"Adiciona uma seta à frente as linhas do bate-papo para copiar a linha inteira."
...
L["Adjust the scale of the minimap and also the pins. Eg: Quests, Resource nodes, Group members"] =
	"Ajuste a escala do minimapa e também os pinos. Ex: Missões, Nódulos de Recuros, Membros do Grupo"
...
L["Allow newly learned spells to be automatically placed on an empty actionbar slot."] =
	"Permitir novos feitiços serem adicionados automaticamentes em uma Barra de Ações com slot vazio"
...
L["Allows you to tie a stack count to an aura when you add it to the list, which allows the trigger to act when an aura reaches X number of stacks."] =
	"Permite você vincular uma contagem de stacks com uma aura quando você a adiciona para uma lista, no qual permite o gatilho agir quando uma aura chegar a um número X de stacks."
...
L["Applies the font and font size settings throughout the entire user interface. Note: Some font size settings will be skipped due to them having a smaller font size by default."] =
	"Aplica as configurações de fonte e tamanho de fonte para toda a interface do usuário. Nota: Algumas configurações de fontes serão puladas por terem uma fonte menor por padrão."
...
L["Apply this filter if a buff has remaining time greater than this. Set to zero to disable."] =
	"Aplicar este Filtro caso um buff tenha um tempo restante maior do que isto. Coloque zero para desabilitar"
L["Apply this filter if a buff has remaining time less than this. Set to zero to disable."] =
	"Aplicar este Filtro caso um buff tenha um tempo restante menor do que isto. Coloque zero para desabilitar"
L["Apply this filter if a debuff has remaining time greater than this. Set to zero to disable."] =
	"Aplicar este Filtro caso um debuff tenha um tempo restante maior do que isto. Coloque zero para desabilitar"
L["Apply this filter if a debuff has remaining time less than this. Set to zero to disable."] =
	"Aplicar este Filtro caso um debuff tenha um tempo restante menor do que isto. Coloque zero para desabilitar"
L["Apply To All"] = "Aplicar a Todos"
L["Archaeology Frame"] = "Arqueologia"
L["Are you sure you want to reset ActionBars settings?"] =
	"Tem certeza que deseja resetar as configurações das Barra de Ações?"
...
L["Are you sure you want to reset Cooldown settings?"] =
	"Tem certeza que deseja resetar as configurações do Tempo de Recarga?"
L["Are you sure you want to reset DataBars settings?"] =
	"Tem certeza que deseja resetar as configurações das Barra de Dados?"
L["Are you sure you want to reset DataTexts settings?"] =
	"Tem certeza que deseja resetar as configurações dos Textos Informativos?"
L["Are you sure you want to reset General settings?"] =
	"Tem certeza que deseja resetar as configurações da aba Geral?"
L["Are you sure you want to reset NamePlates settings?"] =
	"Tem certeza que deseja resetar as configurações das Placas de Informação?"
...
L["Are you sure you want to reset UnitFrames settings?"] =
	"Tem certeza que deseja resetar as configurações dos Quadros Informativos?"
...
L["Attempts to center UI elements in a 16:9 format for ultrawide monitors"] =
	"Tenta centralizar elementos da IA em um formato 16:9 para monitores ultrawide"
...
L["Automatically hide the objective frame during boss fights while you are running a key."] =
	"Automaticamente esconder o quadro objetivo durante as lutas de boss enquanto em uma pedra-chave."
L["Automatically hide the objective frame during boss or arena fights."] =
	"Automaticamente esconder o quadro de objetivo durante uma luta de boss ou arena"
...
L["Blocks datatext tooltip from showing in combat."] =
	"Bloquear todos os Textos Informativos na Tooltip durante um combate."
...
L["Change the scale of the Game Menu which shows up when you press ESC."] =
	"Mudar a escala do Menu do Jogo que aparece quando você aperta ESC."
L["Change the width and controls how big of an area on the screen will accept clicks to target unit."] =
	"Mudar a largura e controla o quão grande a área na tela será para aceitar cliques na unidade"
...
L["Check these to only have the filter active in certain difficulties. If none are checked, it is active in all difficulties."] =
	"Cheque estes para ter o filtro apenas ativo em certas dificuldades. Se nenhum estiver checados, ficará ativo em todas as dificuldades."
...
L["Choose UIPARENT to prevent it from hiding with the unitframe."] =
	"Escolha UIParent para evitá-lo de esconder com o Quadro de Jogador"
...
L["Choose when you want the tooltip to show in combat. If a modifier is chosen, then you need to hold that down to show the tooltip."] =
	"Escolha quando você quiser que o Tooltip apareça em combate. Se um modificador for escolhido, então você precisará segurá-lo para que o Tooltip apareça."
L["Choose when you want the tooltip to show. If a modifier is chosen, then you need to hold that down to show the tooltip."] =
	"Escolha quando você quiser que o Tooltip apareça. Se um modificador for escolhido, então você precisará segurá-lo para que o Tooltip apareça."
L["Chromie Time Frame"] = "Quadro do Tempo de Chromie"
L["Clamp nameplates to the top of the screen when outside of view."] =
	"Empilhar Placas de identificação no topo da tela quando fora de vista"
...
L["Color castbar by the reaction of the unit to the player."] =
	"Colorir Barra de Lançamento pela reação da unidade ao jogador."
...
L["Color castbars by the reaction type of non-player units."] =
	"Colorir Barra de Lançamentos pelo tipo de reação de unidades não-jogadoras"
...
L["Color Keybind Text when Out of Range, instead of the button."] =
	"Cor Tecla de Atalho quando fora de alcance, ao invés do botão"
...
L["Color of the actionbutton when out of power (Mana, Rage, Focus, Holy Power)."] =
	"Cor do botão de ação quando sem poder (Mana, Raiva, Foco, Poder Sagrado)."
...
L["Color the unit healthbar if there is a debuff that can be dispelled by you."] =
	"Cor da barra de vida se existir um Debuff que você possa dissipar."
...
L["Color when the text is using a modified timer rate."] =
	"Colorir quando o texto estiver usando uma taxa de modificação de tempo."
L["COLOR"] = "Cor"
...
L["Colors the border according to the type of items assigned to the bag."] =
	"Colorir as bordas de acordo com o tipo de item assinalado para a bolsa."
L["Colors"] = "Cores"
...
L["Control enemy nameplates toggling on or off when in combat."] =
	"Controla a Placa de identificação Inimiga mostrando/ocultando quando em combate."
L["Control friendly nameplates toggling on or off when in combat."] =
	"Controla a Placa de identificação Aliada mostrando/ocultando quando em combate."
L["Controls how big of an area on the screen will accept clicks to target unit."] =
	"Controla quão grande uma área de tela irá aceitar cliques para um alvo inimigo"
L["Controls how many seconds of inactivity has to pass before chat is faded."] =
	"Controla quantos segundos de inatividade tem que se passar antes que o bate-papo desvaneça."
L["Controls the amount of decimals used in values displayed on elements like NamePlates and UnitFrames."] =
	"Controlar o número de decimais utilizados em valores mostrados como Placas de identificação e Quadro de Unidades."
L["Controls the speed at which smoothed bars will be updated."] =
	"Controla a velocidade na qual as barras suaves serão atualizadas."
L["Controls the text displayed. Tags are available in the Available Tags section of the config."] =
	"Controla os textos mostrados. Tags estão disponíveis na seção de Tags Disponíveis na configuração."
...
L["Copy settings from %s. This will overwrite %s profile.\n\n Are you sure?"] =
	"Copiar configurações de %s. Isso irá sobrescrever o perfil %s.\n\n Tem certeza?"
...
L["DEBUG_DESC"] =
	"Desabilitar todos os addons (incluindo Plugins) exceto o ElvUI. Durante esta mesma seção, isto pode ser clicado para reativá-los."
...
L["Display a healer icon over known healers inside battlegrounds or arenas."] =
	"Mostra um ícone de Curandeiro sobre curandeiros conhecidos em campos de batalha ou arenas."
...
L["Display a spark texture at the end of the castbar statusbar to help show the differance between castbar and backdrop."] =
	"Exibir uma textura de faísca no fim da Barra de Lançamento para ajudar a diferenciar a barra de cast e o fundo."
L["Display a tank icon over known tanks inside battlegrounds or arenas."] =
	"Exibir um ícone de tanque sobre os tanques dentro de campos de batalha ou arenas."
L["Display battleground messages in the middle of the screen."] =
	"Mostra mensagens do campo de batalha no meio da tela."
...
L["Display icon on arena frame indicating the units talent specialization or the units faction if inside a battleground."] =
	"Exibir um ícone nos quadros de arena indicando a especialização de talentos das unidades ou a sua facção dentro dum Campo de Batalha"
...
L["Display Target's Aura Duration, when there is no CD displaying."] =
	"Mostrar a Duração da Aura do Alvo, quando não há uma recarga sendo mostrada."
L["Display Text"] = "Mostrar Texto"
L["Display the castbar icon inside the castbar."] =
	"Mostrar o Ícone da Barra de Lançamento dentro da Barra de Lançamento."
...
L["Display the item level and current specialization of the unit on modifier press."] =
	"Mostra o nível do item e especialização atual da unidade quando um modificador for pressionado."
L["Display the name of the unit on the chat bubble. This will not work if backdrop is disabled or when you are in an instance."] =
	"Mostrar o nome da unidade na bolha do chat. Isso não irá funcionar se o fundo estiver desabilitado ou você estiver em uma instância."
...
L["Display the unit name who interrupted a spell on the castbar. You should increase the Time to Hold to show properly."] =
	"Mostrar o nome da unidade que interrompeu um feitiço na barra de feitiços. Você deve aumentar o Tempo de Mostra para aparecer apropriadamente."
...
L["Display tick marks on the castbar for channelled spells. This will adjust automatically for spells like Drain Soul and add additional ticks based on haste."] =
	"Exibir marcas na barra de cast para feitiços canalizados. Isto irá se ajustar automaticamente para feitiços como Drenar Alma e adicionará ticks baseado na Aceleração."
...
L["Displays a detailed report of every item sold when enabled."] =
	"Mostra um relatório detalhado de cada item vendido quando habilitado."
...
L["Don't display auras that are longer than this duration (in seconds). Set to zero to disable."] =
	"Não mostrar auras que são maiores que esta duração (em segundos). Coloque zero para desabilitar."
L["Don't display auras that are shorter than this duration (in seconds). Set to zero to disable."] =
	"Não mostrar auras que são menores que esta duração (em segundos). Coloque zero para desabilitar."
L["Donations:"] = "Doações:"
L["Down"] = "Baixo"
...
L["Enable the use of separate size options for the right chat panel."] =
	"Habilitar o uso de opções de tamanho separadas para o painel direito de bate-papo."
...
L["Enable/Disable the minimap. |cffFF3333Warning: This will prevent you from seeing the minimap datatexts.|r"] =
	"Habilitar/Desabilitar o minimapa. |cffFF3333Perigo: Isso irá prevení-lo de ver os Textos Informativos do minimapa.|r"
L["Enable/Disable the on-screen zone text when you change zones."] =
	"Habilitar/Desabilitar o texto de zona na tela quando você muda de zona."
...
L["Enables the five-second-rule ticks for Mana classes and Energy ticks for Rogues and Druids."] =
	"Habilitar a regra de cinco segundos para classes com Mana e Energia como Ladinos e Druídas"
L["Enabling this allows raid-wide sorting however you will not be able to distinguish between groups."] =
	"Habilitar isso irá permitir a organização pela largura da raid porém você não conseguirá distinguir os grupos."
L["Enabling this inverts the grouping order when the raid is not full, this will reverse the direction it starts from."] =
	"Habilitar isso irá inverter a ordem dos grupos quando um Raid não está cheia, isso irá reverter a direção que uma raid começa."
...
L["Error decoding data. Import string may be corrupted!"] =
	"Erro ao decodificar os dados. A string de importação pode estar corrompida!"
...
L["Fade out the tooltip when it disappers, instant otherwise. Cursor anchored tooltips are unaffected."] =
	"Desvanecer a dica quando ela desaparecer, será instântanea caso contrário. Dicas ancoras ao Cursor não são afetadas."
...
L["Fades the buttons that toggle chat windows when that window has been toggled off."] =
	"Desvanece os botões que habilitam/desabilitam as janelas de bate-papo quando essa janela for desabilitada."
L["Fades the text on chat tabs that are docked in a panel where the backdrop is disabled."] =
	"Desvanece o textos das abas de bate-papo que estão ancoradas em um painel onde o fundo está desabilitado."
L["Fades the text on chat tabs that are not docked at the left or right chat panel."] =
	"Desvanece o texto das abas de bate-papo que não estão ancoradas ao painel esquerdo ou direito."
L["Fill"] = "Preencher"
L["Filled"] = "Preenchido"
...
L["Force the frames to show, they will act as if they are the player frame."] =
	"Forçar os quadros a aparecerem. Eles irão se comportar como se fossem o quadro do jogador."
...
L["Forces Mouseover Glow to be disabled for these frames"] =
	"Força o Brilho ao Pairar o Mouse ser desabilitado para estes quadros."
L["Forces reaction color instead of class color on units controlled by players."] =
	"Força cor de reação em vez de cor de classe para unidades controladas por jogadores."
...
L["Groups will be maxed as Mythic to 4, Other Raids to 6, and PVP / World to 8."] =
	"Grupos serão no máximo: 4 em Mítico, outras Raídes 6, e PVP / Mundo 8."
...
L["Height of the objective tracker. Increase size to be able to see more objectives."] =
	"Altura do rastreador de objetivos. Aumente o tamanho para poder ver mais objetivos."
L["Height"] = "Altura"
...
L["Here you can add items that you want to be excluded from sorting. To remove an item just click on its name in the list."] =
	"Aqui você pode adicionar items que você quer excluir da classificação. Para remover um item apenas clique no seu nome na lista."
...
L["Hide Castbar text. Useful if your power height is very low or if you use power offset."] =
	"Esconder texto na barra de cast. Útil quando a altura do seu Poder é muito pequena ou se você usa deslocamento de Poder."
...
L["Hide specific sections in the datatext tooltip."] =
	"Esconder seção específica nos tooltip dos textos informativos"
...
L["Hides the bling animation on buttons at the end of the global cooldown."] =
	"Esconder a animação nos botões no fim de um tempo de recarga global."
L["Hides the yellow quest progress text and red error text at the top of the screen while in combat."] =
	"Esconde o texto amarelo de progresso das missões e o texto de erro vermelho do topo da tela quando em combate."
L["High"] = "Alto"
...
L["How many seconds the castbar should stay visible after the cast failed or was interrupted."] =
	"Quantos segundos a barra de lançamento deve continuar visível depois de um lançamento falhar ou ser interrompido."
L["How much time before the cutaway health starts to fade."] =
	"Quanto tempo antes da vida cortada começar a desvanecer."
L["How much time before the cutaway power starts to fade."] =
	"Quanto tempo antes do poder cortado começar a desvanecer."
...
L["If enabled then it checks if auras are missing instead of being present on the unit."] =
	"Se habilitado então irá checar se a aura está faltando ao invés de estar presente na unidade."
L["If enabled then it will require all auras to activate the filter. Otherwise it will only require any one of the auras to activate it."] =
	"Se habilitado então irá requerer todas as auras para ativar o filtro. Caso contrário irá apenas requerer qualquer uma das auras para ativá-lo."
L["If enabled then it will require all cooldowns to activate the filter. Otherwise it will only require any one of the cooldowns to activate it."] =
	"Se habilitado então irá requerer todos os tempo de recarga para ativar o filtro. Caso contrário irá apenas requerer qualquer um dos tempo de recargas para ativá-lo."
L["If enabled then the filter will activate if the unit is casting anything."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade está lançando algo."
L["If enabled then the filter will activate if the unit is channeling anything."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade estiver canalizando algo."
L["If enabled then the filter will activate if the unit is not casting anything."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade não estiver lançando algo."
L["If enabled then the filter will activate if the unit is not channeling anything."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade não estiver canalizando algo."
L["If enabled then the filter will only activate if the level of the unit is equal to or higher than this value."] =
	"Se habilitado então o filtro irá apenas ser ativado se o level da unidade for igual ou maior que este valor."
L["If enabled then the filter will only activate if the level of the unit is equal to or lower than this value."] =
	"Se habilitado então o filtro irá apenas ser ativado se o level da unidade for igual ou menor que este valor."
L["If enabled then the filter will only activate if the level of the unit matches this value."] =
	"Se habilitado então o filtro irá apenas ser ativado se o level da unidade for igual a este valor."
L["If enabled then the filter will only activate if the level of the unit matches your own."] =
	"Se habilitado então o filtro irá apenas ser ativado se o level da unidade for igual ao seu."
L["If enabled then the filter will only activate if the unit is casting interruptible spells."] =
	"Se habilitado então o filtro irá apenas ser ativado se a unidade estiver castando um feitiço interrompível."
L["If enabled then the filter will only activate if the unit is casting not interruptible spells."] =
	"Se habilitado então o filtro irá apenas ser ativado se a unidade estiver castando um feitiço não-interrompível."
L["If enabled then the filter will only activate if the unit is not casting or channeling one of the selected spells."] =
	"Se habilitado então o filtro irá apenas ser ativado se a unidade não estiver castando ou canalizando um dos feitiços selecionados."
L["If enabled then the filter will only activate when the unit can be attacked by the active player."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade poder ser atacada pelo jogador ativo."
L["If enabled then the filter will only activate when the unit can not be attacked by the active player."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade não poder ser atacada pelo jogador ativo."
L["If enabled then the filter will only activate when the unit has a stealable buff(s)."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade tiver um bônus roubável."
L["If enabled then the filter will only activate when the unit has no stealable buff(s)."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade não tiver um bônus roubável."
L["If enabled then the filter will only activate when the unit is controlled by the player."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade estiver controlado pelo jogador."
L["If enabled then the filter will only activate when the unit is in a Vehicle."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade estiver em um Veículo."
L["If enabled then the filter will only activate when the unit is in combat."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade estiver em combate."
L["If enabled then the filter will only activate when the unit is in your Party."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade estiver em seu Grupo."
L["If enabled then the filter will only activate when the unit is in your Raid."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade estiver em sua Raíde."
L["If enabled then the filter will only activate when the unit is not controlled by the player."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade não estiver sendo controlada pelo jogador."
L["If enabled then the filter will only activate when the unit is not in a Vehicle."] =
	"Se habilitado então o filtro irá apenas ser ativado quando não estiver em um Veículo."
L["If enabled then the filter will only activate when the unit is not in your Party."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade não estiver no seu Grupo."
L["If enabled then the filter will only activate when the unit is not in your Raid."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade não estiver na sua Raíde."
L["If enabled then the filter will only activate when the unit is not owned by the player."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade não pertencer ao jogador."
L["If enabled then the filter will only activate when the unit is not pvp-flagged."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade não for pvp-flagged."
L["If enabled then the filter will only activate when the unit is not tap denied."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade não for estiver reservada."
L["If enabled then the filter will only activate when the unit is not targeting you."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade não tiver como você como alvo."
L["If enabled then the filter will only activate when the unit is not the active player's pet."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade não for o pet do jogador ativo."
L["If enabled then the filter will only activate when the unit is out of combat."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade estiver fora de combate."
L["If enabled then the filter will only activate when the unit is owned by the player."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade não for pertencente pelo jogador."
L["If enabled then the filter will only activate when the unit is pvp-flagged."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade for pvp-flagged."
L["If enabled then the filter will only activate when the unit is tap denied."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade estiver reservada."
L["If enabled then the filter will only activate when the unit is targeting you."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade ter você como alvo."
L["If enabled then the filter will only activate when the unit is the active player's pet."] =
	"Se habilitado então o filtro irá apenas ser ativado quando a unidade é o pet ativo do jogador."
L["If enabled then the filter will only activate when you are focusing the unit."] =
	"Se habilitado então o filtro irá apenas ser ativado quando você estiver focando a unidade."
L["If enabled then the filter will only activate when you are in a Vehicle."] =
	"Se habilitado então o filtro irá apenas ser ativado quando você estiver em um Veículo."
L["If enabled then the filter will only activate when you are in combat."] =
	"Se habilitado então o filtro irá apenas ser ativado quando você estiver em combate."
L["If enabled then the filter will only activate when you are not focusing the unit."] =
	"Se habilitado então o filtro irá apenas ser ativado quando você não estiver focando a unidade."
L["If enabled then the filter will only activate when you are not in a Vehicle."] =
	"Se habilitado então o filtro irá apenas ser ativado quando você não estiver em um Veículo."
L["If enabled then the filter will only activate when you are not targeting the unit."] =
	"Se habilitado então o filtro irá apenas ser ativado quando você não ter a unidade como alvo."
L["If enabled then the filter will only activate when you are out of combat."] =
	"Se habilitado então o filtro irá apenas ser ativado quando você estiver fora de combate."
...
L["If enabled then the filter will only activate when you are targeting the unit."] =
	"Se habilitado então o filtro irá apenas ser ativado quando você ter a unidade como alvo."
L["If enabled then the filter will only activate when you have a target."] =
	"Se habilitado então o filtro irá apenas ser ativado quando você tiver um alvo."
L["If enabled, the style filter will only activate when you are in one of the instances specified in Instance ID."] =
	"Se habilitado, então o estilo de filtro irá apenas ser ativado quando você estiver em uma das instâncias especificadas nos IDs da Instância."
L["If enabled, the style filter will only activate when you are in one of the maps specified in Map ID."] =
	"Se habilitado, então o estilo de filtro irá apenas ser ativado quando você estiver em um dos mapas espeficiados em um dos IDs do Mapa."
L["If enabled, the style filter will only activate when you are in one of the subzones specified in Add Subzone Name."] =
	"Se habilitado, então o estilo de filtro irá apenas ser ativado quando você estiver em uma das subzonas especificada em Adicionar Nome da Subzona."
L["If enabled, the style filter will only activate when you are in one of the zones specified in Add Zone Name."] =
	"Se habilitado, então o estilo de filtro irá apenas ser ativado quando você estiver em uma das zonas especificadas em Adicionar Nome da Zona."
L["If enabled, then this currency will be displayed in the main Currencies datatext tooltip."] =
	"Se habilitado, então esta moeda será mostrada na tooltip das moedas principais dos textos informativos."
...
L["If not set to true then the server time will be displayed instead."] =
	"Se não definido como verdade, então a hora do servidor será exibida."
L["If the aura is listed with a number then you need to use that to remove it from the list."] =
	"Se a aura estiver listada com um número então você precisará usar isto para removê-la da lista."
L["If this is enabled then the reaction check will use your reputation with the faction the unit belongs to."] =
	"Se isto estiver habilitado então a checagem de reação usará sua reputação com a facção a qual a unidade pertence."
L["If this list is empty, and if Interruptible is checked, then the filter will activate on any type of cast that can be interrupted."] =
	"Se esta lista estiver vazia e Interrompível estiver ligado, então este filtro irá ativar em qualquer tipo de cast interrompível."
L["If this threshold is used then the health of the unit needs to be higher than this value in order for the filter to activate. Set to 0 to disable."] =
	"Se este limiar for usado, então a vida da unidade precisa ser maior que este valor para o filtro ser ativado. Coloque 0 para desabilitar."
L["If this threshold is used then the health of the unit needs to be lower than this value in order for the filter to activate. Set to 0 to disable."] =
	"Se este limiar for usado, então a vida da unidade precisa ser menor que este valor para o filtro ser ativado. Coloque 0 para desabilitar."
L["If this threshold is used then the power of the unit needs to be higher than this value in order for the filter to activate. Set to 0 to disable."] =
	"Se este limiar for usado, então o poder da unidade precisa ser maior que este valor para o filtro ser ativado. Coloque 0 para desabilitar."
L["If this threshold is used then the power of the unit needs to be lower than this value in order for the filter to activate. Set to 0 to disable."] =
	"Se este limiar for usado, então o poder da unidade precisa ser menor que este valor para o filtro ser ativado. Coloque 0 para desabilitar."
L["If you have a lot of 3D Portraits active then it will likely have a big impact on your FPS. Disable some portraits if you experience FPS issues."] =
	"Se você tem vários Retratos 3D ativos então você provavelmente terá um grande impacto no seu FPS. Desabilite alguns Retratos se você encontrar algum problema com FPS."
L["If you have any plugins supporting this feature installed you can find them in the selection dropdown to the right."] =
	"Se você tiver algum plugin suportando esta funcionalidade instalado você pode achá-lo no menu dropdown à direita."
L["If you unlock actionbars then trying to move a spell might instantly cast it if you cast spells on key press instead of key release."] =
	"Se você destravar as Barras de Ações, tentar mover um feitiço pode fazê-lo ser lançado se você casta feitiços ao pressionar a tecla em vez de quando soltá-la."
...
L["Indicate whether buffs you cast yourself should be separated before or after."] =
	"Indica se os bônus que lança em si próprio devem ser separados antes ou depois."
...
L["List of words to color in chat if found in a message. If you wish to add multiple words you must separate the word with a comma. To search for your current name you can use %MYNAME%.\n\nExample:\n%MYNAME%, ElvUI, RBGs, Tank"] =
	"Lista de palavras a colorir se encontrada numa mensagem. Se desejar adicionar multiplas palavras deverá separa-las com uma vírgula. Para procurar pelo seu nome atual pode usar %MYNAME%.\n\nExemplo:\n%MYNAME%, ElvUI, RBGs, Tank"
...
L["Lower numbers mean a higher priority. Filters are processed in order from 1 to 100."] =
	"Números menores significam maior prioridade. Filtros são processados em ordem de 1 a 100."
...
L["Make the unitframe glow when it is below this percent of health."] =
	"Faz o quadro de unidade brilhar quanto estiver abaixo desta porcentagem de vida."
...
L["Marks the most valuable quest reward with a gold coin."] =
	"Marca a recompensa mais valiosa da quest com uma moeda de ouro."
...
L["Max amount of overflow allowed to extend past the end of the health bar."] =
	"Quantidade máxima de sobreposição permitida para extender além do fim da barra de vida."
...
L["Max Overflow is set to zero. Absorb Overflows will be hidden when using Overflow style.\nIf used together Max Overflow at zero and Overflow mode will act like Normal mode without the ending sliver of overflow."] =
	"Sobreposição Máxima não está configurada para azero. A Sobreposição de Absorção será escondida quando estiver utilizando o estilo de Sobreposição.\nSe utilizados juntos a Sobreposição Máxima em zero e a Sobreposição vão agir como o modo Normal sem o traço final da sobreposição."
...
L["Maximum tick rate allowed for tag updates per second."] =
	"Taxa máxima de tick permitida para atualizações de Tags por segundo."
...
L["Must be in group with the player if he isn't on the same server as you."] =
	"Deve estar em um grupo com o jogador se ele não estiver no mesmo servidor que você."
...
L["Number of repeat characters while in combat before the chat editbox is automatically closed."] =
	"Número de caracteres repetidos enquanto em combate antes da caixa de edição do bate-papo ser automaticamente fechada."
...
L["Offset of the powerbar to the healthbar, set to 0 to disable."] =
	"A distância entre barra de poder e a barra de vida, definir 0 para desativar."
L["Offset"] = "Distância"
...
L["Only highlight the aura that originated from you and not others."] =
	"Apenas destacar a aura que originou de você e não de outros."
L["Only load nameplates for units within this range."] =
	"Apenas carregar placas de identificação para unidades dentro desta distância."
...
L["Overlay mode is forced when the Frame Orientation is set to Middle."] =
	"Modo de Sobreposição é forçado quando a Orientação do Quadro estiver em Meio."
L["Overlay"] = "Sobrepor"
...
L["Position of bonus quest reward frame relative to the objective tracker."] =
	"Posição da recompensa bonus de quest relativo ao rastreador de objetivos"
...
L["Replaces the default Blizzard fonts on various panels and frames with the fonts chosen in the Media section of the ElvUI Options. NOTE: Any font that inherits from the fonts ElvUI usually replaces will be affected as well if you disable this. Enabled by default."] =
	"Substituir as fontes padrão da Blizzard em vários painéis com as fontes escolhidas na seção de Mídia das Opções do ElvUI. NOTA: Qualquer fonte que segue as fontes que o ElvUI normalmente substitui também será afetada por isto se você desabilitar. Habilitado por padrão."
...
L["Replaces the StatusBar texture setting on Unitframes and Nameplates with the primary texture."] =
	"Substituir a textura da Barra de Estado dos Quadros de Unidades e Placas de Identificação com a textura primária."
...
L["Require holding the Alt key down to move cursor or cycle through messages in the editbox."] =
	"Requere segurar a tecla ALT para mover or cursor ou percorrer pelas mensagens no box de edição."
...
L["Reset Nameplate CVars to the ElvUI recommended defaults."] =
	"Restaurar CVars das Placas de identificação para o recomendado pelo ElvUI."
...
L["Reverse Toggle will enable Cooldown Text on this module when the global setting is disabled and disable them when the global setting is enabled."] =
	"Inverter a Habilitação vai habilitar o Texto de Recarga deste módulo quando a configuração global estiver desabilitada e irá desabilitá-la quando a configuração global estiver habilitada."
...
L["Set the alpha level of portrait when frame is overlayed."] =
	"Define o nível de transparência para o retrato quando o quadro estiver sobreposicionado."
L["Set the filter type. Blacklist will hide any auras in the list and show all others. Whitelist will show any auras in the filter and hide all others."] =
	"Define o tipo de filtro. Lista-negra irá esconder qualquer aura nesta lista e mostrar todas as outras. Lista de Permissão irá apenas mostrar as auras neste filtro e esconder as outras."
...
L["Set to either stack nameplates vertically or allow them to overlap."] =
	"Define para ou amontoar Placas de identificação verticalmente ou deixar com que elas se sobreponham."
...
L["Show an incoming heal prediction bar on the unitframe. Also display a slightly different colored bar for incoming overheals."] =
	"Mostra a barra de predição de cura no quadro de unidade. Também exibe uma barra com uma cor ligeiramente diferente para a predição de sobrecura."
...
L["Show clickable Quick Join messages inside of the chat."] =
	"Mostrar mensagens de entradas-rápidas clicáveis dentro do chat."
...
L["Show the castbar icon desaturated if a spell is not interruptible."] =
	"Mostrar o ícone da barra de cast desaturado se um feitiço não for interrompível."
...
L["Shows a swipe animation when a spell is recharging but still has charges left."] =
	"Mostra uma animação de deslizamento quando um feitiço estiver recarregando mas ainda tiver cargas restantes."
L["Shows item level of each item, enchants, and gems on the character page."] =
	"Mostra o Nível de Item de cada item, encantamentos e gemas na página do personagem."
L["Shows item level of each item, enchants, and gems when inspecting another player."] =
	"Mostra o Nível de Item de cada item, encantamentos e gemas quando inspecionando outros jogadores."
...
L["The button you must hold down in order to drag an ability to another action button."] =
	"Botão que deve ser pressionado para permitir o arrastar uma habilidade para outro botão de ação"
L["The debuff needs to reach this amount of stacks before it is shown. Set to 0 to always show the debuff."] =
	"O debuff precisa alcançar este montante de stacks antes de aparecer. Coloque 0 para sempre mostrá-lo"
L["The direction that the bag frames be (Horizontal or Vertical)."] =
	"Direção em que os quadros das bolsas são (Horizontal ou Vertical)."
L["The direction that the bag frames will grow from the anchor."] =
	"Direção para qual as barras crescerão a partir do seu Fixador."
L["The direction the auras will grow and then the direction they will grow after they reach the wrap after limit."] =
	"A direção que as auras vão crescer e então a direção que elas vão crescer após chegarem no limite."
...
L["The display format of the money text that is shown at the top of the main bag."] =
	"O formato de exibição do texto do dinheiro que é mostrado no topo da bolsa principal."
L["The display format of the money text that is shown in the gold datatext and its tooltip."] =
	"O formato de exibição do texto de dinheiro que é mostrado no textos informativos de ouro e sua tooltip."
L["The durability percent that the datatext will start flashing.  Set to -1 to disable"] =
	"A porcentagem de durabilidade ao qual o texto informativo irá começar a piscar. Coloque -1 para desabilitar"
...
L["The font that appears on the text above players heads. |cffFF3333WARNING: This requires a game restart or re-log for this change to take effect.|r"] =
	"A fonte do texto que aparece sobre a cabeça dos jogadores. |cffFF3333ATENÇÃO: Para esta alteração fazer efeito é necessário que o jogo seja reiniciado ou relogado.|r"
L["The font that combat text will use. |cffFF3333WARNING: This requires a game restart or re-log for this change to take effect.|r"] =
	"Fonte que o texto de combate usará. |cffFF3333AVISO: Para que as mudanças sejam efetuadas é necessário reiniciar ou relogar o jogo."
...
L["The Portrait will overlay the Healthbar. This will be automatically happen if the Frame Orientation is set to Middle."] =
	"O retrato irá sobrepor a Barra de Vida. Isso irá acontecer automaticante se a Orientação de Quadro estiver definida como Meio"
...
L["The Thin Border Theme option will change the overall apperance of your UI. Using Thin Border Theme is a slight performance increase over the traditional layout."] =
	"O Tema de Bordas Finas irá mudar a aparência geral da sua interface. Usar o Tema de Bordas Finas é uma pequena melhoria comparado ao leiatue tradicional."
L["The unit prefixes you want to use when values are shortened in ElvUI. This is mostly used on UnitFrames."] =
	"Os prefixos de unidade que você quer usar quando valores são encurtados pelo ElvUI. Isso é na maioria das vezes usado nos Quadros de Unidades."
...
L["These filters don't use a list of spells like the regular filters. Instead they use the WoW API and some code logic to determine if an aura should be allowed or blocked."] =
	"Estes filtros não usam uma lista de feitiços como filtros normais. Ao invés disso, eles usam o API do WoW e alguma lógica de codificação para determina se uma aura deve ou não ser bloqueada."
L["These filters use a list of spells to determine if an aura should be allowed or blocked. The content of these filters can be modified in the Filters section of the config."] =
	"Estes filtros usam uma lista de feitiços para determinar se uma Aura deve ou não ser bloqueada. O conteúdo desses filtros pode ser modificada nas configurações de Filtros."
...
L["This allows you to create a new datatext which will track the currency with the supplied currency ID. The datatext can be added to a panel immediately after creation."] =
	"Isto permite que você crie Textos de Informaçãso que irão rastrear a moeda com o ID que foi inserido. O Texto de Informação pode ser adicionado ao painel logo após sua criação."
...
L["This dictates the size of the icon when it is not attached to the castbar."] =
	"Isso dita o tamanho do ícone quando não está anexado a barra de cast."
...
L["This is for Customized Icons in your Interface/Icons folder."] =
	"Isto é para os Ícones Customizados na sua pasta de Interface/Ícones."
L["This list will display any textures Boss Mods have sent to the Boss Mod Auras element during the current session."] =
	"Esta lista vai mostrar qualquer textura que Boss Mods mandou para o elemento de Aura Boss Mod durante a seção atual."
L["This opens the AuraBar Colors filter. These settings affect specific spells."] =
	"Isto abre o Filtro de Cores das Barras de Aura. Estas configurações afetam feitiços específicos."
L["This opens the UnitFrames Color settings. These settings affect all unitframes."] =
	"Isto abre as configurações de Cor de Quadros de Unidades. Estas configurações afetam TODOS os Quadros de Unidades."
L["This option allows the overlay to span the whole health, including the background."] =
	"Esta opção permite a sobreposição abranger toda a vida, incluindo o background."
L["This option controls the Blizzard setting for whether or not the Nameplates should be shown."] =
	"Esta opção controlar as configurações da Blizzard para se os Quadros de Unidades devem ou não serem mostrados."
L["This option will force hide Blizzard's cooldown text if it is enabled at [Interface > ActionBars > Show Numbers on Cooldown]."] =
	"Esta opção irá forçar a escondar o texto de Tempo de Recarga da Blizzard se ele estiver habilitado em [Interface > Barras de Ações > Mostrar Números em Tempo de Recarga]."
L["This section will allow you to copy settings to a select module from or to a different profile."] =
	"Esta seção irá permitir que você copie configurações de um módulo selecionado para outro perfil."
L["This section will help reset specfic settings back to default."] =
	"Esta seção irá ajudá-lo a resetar configurações específicas para o padrão."
L["This selects the Chat Frame to use as the output of ElvUI messages."] =
	"Isto seleciona o Quadro de Bate-papo para usar como saída para mensagens do ElvUI."
L["This setting controls the size of text in item comparison tooltips."] =
	"Esta opção controla o tamanho do texto na comparação no tooltip."
...
L["This uses the IsPlayerSpell API which is only required sometimes."] =
	"Isto utiliza a API IsPlayerSpell da Blizzard que só é necessária as vezes."
L["This will allow you to toggle flashing of the time datatext when there are calendar invites."] =
	"Isto vai permitir que voce alterne o brilho do texto de informação de tempo quando tiver convites para o calendário."
L["This will join auras together which are normally separated. Example: Bolstering and Force of Nature."] =
	"Isto vai juntar auras que ficam normalmente separadas. Exemplo: Força da Natureza."
L["This will override the global cooldown settings."] =
	"Isto irá sobrescrever as configurações globais de Tempo de Recarga."
L["This will pin the voice buttons to the chat's tab panel. Unchecking it will create a voice button panel with a mover."] =
	"Isto irá pinar os botões de voz no painel de bate-papo. Deselecionar isto irá criar um botão de voz que pode ser movido."
L["This will reset the contents of this filter back to default. Any spell you have added to this filter will be removed."] =
	"Isto irá resetar todo o conteúdo de um filtro de volta para seu padrão. Qualquer feitiço que você adicionou a este filtro será removido."
L["This works like a macro, you can run different situations to get the actionbar to page differently.\n Example: '[combat] 2;'"] =
	"Isto funciona como uma macro, você pode ter várias situações para ter a barra de ações paginando diferentemente.\nExemplo: '[combat] 2;'"
L["This works like a macro, you can run different situations to get the actionbar to show/hide differently.\n Example: '[combat] show;hide'"] =
	"Isto funciona como uma macro, você pode ter várias situações para ter a barra de ações mostrando/escondendo diferentemente.\nExemplo: '[combat] show;hide'"
...
L["Threshold (in minutes) before text is shown in the HH:MM format. Set to -1 to never change to this format."] =
	"Limiar (em minutos) antes do texto ser mostrado no formato HH:MM. Definir -1 para nunca mudar este formato."
L["Threshold (in seconds) before text is shown in the MM:SS format. Set to -1 to never change to this format."] =
	"Limiar (em segundos) antes do texto ser mostrado no formato MM:SS. Definir -1 para nunca mudar este formato."
...
L["Threshold before the icon will fade out and back in. Set to -1 to disable."] =
	"Limiar antes do Ícone desvanecer e voltar. Definir -1 para desabilitar."
...
L["Title will only appear if Name Only is enabled or triggered in a Style Filter."] =
	"O Título irá apenas aparecer se Apenas Nome estiver habilitado ou ter sido ativado em Estilos de Filtro."
L["Title"] = "Título"
...
L["Transparency level when not in combat, no target exists, full health, not casting, and no focus target exists."] =
	"Nível de transparência quando não estiver em combate, nenhum alvo existir, vida cheia, não estiver lançando, e nenhum foco existir."
...
L["Use a more visible flash animation for Auto Attacks."] =
	"Usar uma animação com flash mais visível para Auto-Ataques."
...
L["Use BattleTag instead of Real ID names in chat. Chat History will always use BattleTag."] =
	"Usar BattleTag em vez do nome de ID Real no chat. A histórico do chat sempre usará a BattleTag."
L["Use Blizzard Cleanup"] = "Usar Limpeza da Blizzard"
L["Use class color for the names of players when they are mentioned."] =
	"Usar cor da classe para nome de jogadores quando eles são mencionados."
...
L["Use drag and drop to rearrange filter priority or right click to remove a filter."] =
	"Usar arrastar e soltar para rearranjar a prioridade de filtros ou clique-direito para remover um filtro."
...
L["Use Off Tank Color when another Tank has threat."] =
	"Usar Cor de Tanque Secundário quando outro Tanque tiver Ameaça."
...
L["Use Shift+LeftClick to toggle between friendly or enemy or normal state. Normal state will allow the filter to be checked on all units. Friendly state is for friendly units only and enemy state is for enemy units."] =
	"Use Shift + Clique Esquerdo para alternar entre amigos, inimigos ou estado normal. O estado normal permitirá que filtro seja checado contra todas as unidades. O estado de amigos checará apenas para unidades amigavéis e o estado inimigo é para unidades inimigas."
...
L["Use the profile specific filter Aura Indicator (Profile) instead of the global filter Aura Indicator."] =
	"Usar filtro específico de perfil para o Indicador de Aura (Perfil) ao invés do filtro global Indicador de Aura."
L["Use thin borders on certain nameplate elements."] =
	"Usar bordas finas para certos elementos das placas de identificação."
...
L["Use this backdrop color for units that are dead or ghosts."] =
	"Usar essa cor de backdrop para unidades que estão mortas ou fantasmas."
...
L["When disabled, the Chat Background color has to be set via Blizzards Chat Tabs Background setting."] =
	"Quando desabilitado, a cor do Fundo do Bate-papo tem que ser configurada através da configuração de Fundo de Bate-papo da Blizzard"
L["When enabled it will only show spells that were added to the filter using a spell ID and not a name."] =
	"Quando habilitado irá apenas mostrar feitiços que foram adicionados ao filtro usando o ID do Feitiço e não o nome."
L["When enabled the nameplate will stay visible in a locked position."] =
	"Quando habilitado a Placa de identificação ficará visível em uma área travada."
...
L["When this is enabled, Low Health Threshold colors will not be displayed while targeted."] =
	"Quando estiver habilitado, as cores do Limiar de Vida Baixa não vão ser exibidas quando estiver mirado."
...
L["When using Static Position, this option also requires the target to be attackable."] =
	"Quando usando Posição Estática, essa opção também requere que o alvo seja atacável."
...
L["Will attempt to sell another item in set interval after previous one was sold."] =
	"Irá tentar vender outro item num intervalo definido após o anterior ter sido vendido."
...
L["Will show Buffs in the Debuff position when there are no Debuffs active, or vice versa."] =
	"Irá mostrar Bônus na posição de Penalidades quando não tiver Penalidades ativas, ou vice-versa."
...
L["You are about to reset paging. Are you sure?"] =
	"Você está a prestes de restaurar a paginação. Você tem certeza?"
L['You are going to copy settings for |cffD3CF00"%s"|r from your current |cff4beb2c"%s"|r profile to |cff4beb2c"%s"|r profile. Are you sure?'] =
	'Você irá copiar as configurações para |cffD3CF00"%s"|r do seu atual perfil |cff4beb2c"%s"|r para o perfil |cff4beb2c"%s"|r. Você tem certeza?'
L['You are going to copy settings for |cffD3CF00"%s"|r from |cff4beb2c"%s"|r profile to your current |cff4beb2c"%s"|r profile. Are you sure?'] =
	'Você irá copiar as configurações para |cffD3CF00"%s"|r do perfil |cff4beb2c"%s"|r para seu atual perfil |cff4beb2c"%s"|r. Você tem certeza?'
...
L["You do not need to use Is Casting Anything or Is Channeling Anything for these spells to trigger."] =
	"You não precisa usar Está Castando Qualquer Coisa ou Está Canalizando Qualquer Coisa para esses feitiços desencadearem."
...
L["|cffFF3333This does not work in Instances or Garrisons!|r"] =
	"|cffFF3333Isto não funciona em Instâncias ou Guarnições!|r"
L["|cffFF3333This is for information. This will not change the tags in the UI.|r"] =
	"|cffFF3333Isto é para informação. Isto não irá mudar as tags na IU.|r"
L['|cffFF3333Warning:|r Changing options in this section will apply to all Aura Indicator auras. To change only one Aura, please click "Configure Auras" and change that specific Auras settings. If "Profile Specific" is selected it will apply to that filter set.'] =
	'|cffFF3333Aviso:|r Mudar as opções nesta seção irá aplicar para todos os Indicadores de Aura. Para mudar para apenas uma Aura, por favor clique "Configurar Auras" e mude as configurações daquela Aura específica. Se "Específico para Perfil" estiver selecionado ele irá aplicar para aquele filtro.'
L["|cffFF3333Warning:|r Click the arrow on the dropdown box to see a list of spells."] =
	"|cffFF3333Aviso:|r Clique na seta na caixa de suspensão para ver a lista de feitiços."
L["|cffFF3333Warning:|r Enable and Number of Groups are managed by Smart Raid Filter. Disable Smart Raid Filter in (UnitFrames - General) to change these settings."] =
	"|cffFF3333Aviso:|r O botão Habilitar e Número dos Grupos são gerenciados pelo Filtro de Raide Inteligente. Disabilite o Filtro de Raide Inteligente em (Quadro de Unidades - Geral) para mudar essas configurações."
...
L["VISIBILITY_DESC"] =
	"O macro seguinte tem de ser verdadeira para que o grupo seja mostrado, em adição a qualquer outro filtro que possa já estar definido."
L["TEXTURE_EXAMPLE"] =
...
L["*Whitelists:|r ^Boss, Mount, MyPet, OtherPet, Personal, nonPersonal, CastByUnit, notCastByUnit, Dispellable (includes steal-able), notDispellable, CastByNPC, CastByPlayers, BlizzardNameplate|r"] =
	"*Lista de Permissão:|r ^Chefe, Montaria, MeuMascote, OutroMascote, Pessoal, Não Pessoal, Lançado por Unidade, Não Lançado pela Unidade, Dissipável (incluindo roubável), não Dissipável, Lançado por NPC, Lançado por Jogador, Placas de identificação Blizzard|r"
L["*Blacklists:|r ^blockMount, blockNonPersonal, blockCastByPlayers, blockNoDuration, blockDispellable, blockNotDispellable | A blacklist filter is only effective against filters that come after it in the priority list. It will not block anything from the filters before it.|r"] =
	"*Lista de Bloqueamento:|r ^[Bloquear] Montaria, [Bloquear] Não Pessoal, [Bloquear] Lançado por Jogadores, [Bloquear] Sem Duração, [Bloquear] Dissipável, [Bloquear] Não Dissipável | Um filtro de lista de bloqueamento só é eficaz contra filtros que vem depois dele na lista de prioridade. Ele não vai bloquear nada de filtros antes dele.|r"
L["^A blacklist filter is only effective against filters that come after it in the priority list. It will not block anything from the filters before it."] =
	"^Um filtro de lista de bloqueamento só é eficaz contra filtros que vem depois dele na lista de prioridade. Ele não vai bloquear nada de filtros antes dele."
L["*Boss:|r ^Auras (debuffs only?) cast by a boss unit.|r"] =
	"*Chefe:|r ^Auras (apenas penalidades?) lançadas por uma unidade chefe.|r"
...
L["*nonPersonal:|r ^Auras cast by anyone other than yourself.|r"] =
	"*Não Pessoal:|r ^Auras lançadas por outros que não forem você.|r"
L["*CastByUnit:|r ^Auras cast by the unit of the unitframe or nameplate (so on target frame it only shows auras cast by the target unit).|r"] =
	"*Lançado por Unidade:|r ^Auras lançadas pela unidade do quadro de unidade ou placa de identificação (então em um quadro de alvo ela apenas mostra auras lançadas pela unidade alvo).|r"
L["*notCastByUnit:|r ^Auras cast by anyone other than the unit of the unitframe or nameplate.|r"] =
	"*Não Lançado pela Unidade:|r ^Auras lançadas por qualquer outra unidade que não for a unidade do quadro de unidades ou placa de identificação.|r"
L["*Dispellable:|r ^Auras you can either dispel or spellsteal.|r"] =
	"*Dissipável:|r ^Auras que você pode dissipar ou roubar.|r"
...
L["*CastByPlayers:|r ^Auras cast by any player-controlled unit (so no NPCs).|r"] =
	"*Lançado por Jogador:|r ^Auras lançadas por qualquer unidade controlada por jogador (então nenhum NPC).|r"
L["*blockCastByPlayers:|r ^Blocks any aura that is cast by player-controlled units (so will only show auras cast by NPCs).|r"] =
	"*[Bloquear] Lançado por Jogadores:|r ^Bloqueia qualquer aura que for lançada por unidade controlada por jogador (então vai mostrar apenas auras lançadas por NPCs).|r"
L["*blockNoDuration:|r ^Blocks any aura without a duration.|r"] =
	"*[Bloquear] Sem Duração:|r ^Bloqueia qualquer aura que não tiver duração.|r"
L["*blockNonPersonal:|r ^Blocks any aura that is not cast by yourself.|r"] =
	"*[Bloquear] Não Pessoal:|r ^Bloqueia qualquer aura que não for lançada por você.|r"
L["*Show Everything:|r ^Set 'Max Duration' to 0 & Leave Priority List Empty or (1) Personal | (2) nonPersonal"] =
	"*Mostrar Tudo:|r ^Configure 'Duração Máxima' para 0 e Deixe a Lista de Prioridades Vazia ou com (1) Pessoal | (2) Não Pessoal"
L["*Block Blacklisted Auras, Show Everything Else:|r ^(1) Blacklist| (2) Personal | (3) nonPersonal"] =
	"*Bloquear Auras Bloqueadas, Mostrar Todas as Outras:|r ^(1) Lista de Bloqueamento| (2) Pessoal | (3) Não Pessoal"
L["*Block Auras Without Duration, Show Everything Else:|r ^(1) blockNoDuration | (2) Personal | (3) nonPersonal"] =
	"*Bloquear Auras sem Duração, Mostrar Todas as Outras:|r ^(1) [Bloquear] Sem Duração | (2) Pessoal | (3) Não Pessoal"
L["*Block Auras Without Duration, Block Blacklisted Auras, Show Everything Else:|r ^(1) blockNoDuration | (2) Blacklist | (3) Personal | (4) nonPersonal"] =
	"*Bloquear Auras sem Duração, Bloquear Auras Bloqueadas, Mostrar Todas as Outraws:|r ^(1) [Bloquear] Sem Duração | (2) Lista de Bloqueamento | (3) Pessoal | (4) Não Pessoal"
L["*Block Everything, Except Your Own Auras:|r ^(1) Personal"] =
	"*Bloquear Tudo, Exceto Suas Próprias Auras:|r ^(1) Pessoal"
L["*Block Everything, Except Whitelisted Auras:|r ^(1) Whitelist"] =
	"*Bloquear Tudo, Exceto Auras Permitidas:|r ^(1) Lista de Permissão"
