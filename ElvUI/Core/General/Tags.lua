...
for textFormat in pairs(E.GetFormattedTextStyles) do
	...
	E:AddTag(
		format("classpower:%s", tagFormat),
		(E.myclass == "DEATHKNIGHT" and "RUNE_POWER_UPDATE " or "")
	...
	if tagFormat ~= "percent" then
		E:AddTag(
			format("health:%s:shortvalue", tagFormat),
			"UNIT_HEALTH UNIT_MAXHEALTH UNIT_CONNECTION PLAYER_FLAGS_CHANGED",
			function(unit)
				local status = not UnitIsFeignDeath(unit) and UnitIsDead(unit) and L["Dead"]
					or UnitIsGhost(unit) and L["Ghost"]
					or not UnitIsConnected(unit) and L["Offline"]
				if status then
					return status
		...
		E:AddTag(
			format("power:%s:shortvalue", tagFormat),
			"UNIT_MAXENERGY UNIT_MAXFOCUS UNIT_MAXMANA UNIT_MAXRAGE UNIT_ENERGY UNIT_FOCUS UNIT_MANA UNIT_RAGE UNIT_MAXRUNIC_POWER UNIT_RUNIC_POWER",
			function(unit)
				local powerType = UnitPowerType(unit)
				local min = UnitPower(unit, powerType)
		...
		E:AddTag(
			format("classpower:%s:shortvalue", tagFormat),
			(E.myclass == "MONK" and "UNIT_AURA " or E.myclass == "DEATHKNIGHT" and "RUNE_POWER_UPDATE " or "")
				.. "UNIT_POWER_UPDATE UNIT_MAXPOWER UNIT_DISPLAYPOWER",
			function(unit)
				local powerType = UnitPowerType(unit)
				local min, max = UnitPower(unit, powerType), UnitPowerMax(unit, powerType)
	...
	for textFormat, length in pairs({ veryshort = 5, short = 10, medium = 15, long = 20 }) do
		E:AddTag(
			format("health:current:name-%s", textFormat),
		...
		E:AddTag(
			format("health:deficit-percent:name-%s", textFormat),
			"UNIT_HEALTH UNIT_MAXHEALTH UNIT_NAME_UPDATE",
			function(unit)
				local cur, max = UnitHealth(unit), UnitHealthMax(unit)
		...
		E:AddTag(
			format("name:%s:status", textFormat),
		...
		E:AddTag(
			format("name:%s:translit", textFormat),
...
E:AddTag("permana", "UNIT_DISPLAYPOWER", function(unit)
	...
	if m == 0 then
		...
		return floor(UnitPower(unit, SPELL_POWER_MANA) / m * 100 + 0.5)
	end
end)
...
do
	local gold, silver =
		"|T" .. E.Media.Textures.Nameplates .. ":16:16:0:0:256:128:0:38:45:77|t",
		"|T" .. E.Media.Textures.Nameplates .. ":16:16:0:0:256:128:0:38:82:114|t"
	...
	local typeName =
		{ rare = L["Rare"], rareelite = L["Rare Elite"], elite = L["Elite"], worldboss = L["Boss"], minus = L["Affix"] }
...
do
	Tags.Env.GetQuestData = function(unit, which, Hex)
		if IsInInstance() or UnitIsPlayer(unit) then
			return
		end

		local notMyQuest, lastTitle
		local info = E.ScanTooltip:GetUnitInfo(unit)
		if not (info and info.lines[2]) then
			return
		end
...
E.TagInfo = {
	...
	["class:icon"] = {
		category = "Class",
		description = "Displays the class icon of the unit, if that unit is a player",
	},
	...
	["spec:icon"] = {
		category = "Class",
		description = "Displays the specialization icon of the unit, if that unit is a player",
	},
	-- Classification
	["affix"] = { category = "Classification", description = "Displays low level critter mobs" },
	["classification:icon"] = {
		category = "Classification",
		description = "Displays the unit's classification in icon form (golden icon for 'ELITE' silver icon for 'RARE')",
	},
	["classification"] = {
		category = "Classification",
	...
	-- Classpower
	["classpower:current-max-percent"] = {
		category = "Classpower",
		description = "Displays the unit's current and max amount of special power, separated by a dash (% when not full power)",
	},
	["classpower:current-max"] = {
		category = "Classpower",
		description = "Displays the unit's current and max amount of special power, separated by a dash",
	},
	["classpower:current-percent"] = {
		category = "Classpower",
		description = "Displays the unit's current and percentage amount of special power, separated by a dash",
	},
	["classpower:current"] = {
		category = "Classpower",
		description = "Displays the unit's current amount of special power",
	},
	["classpower:deficit"] = {
		category = "Classpower",
		description = "Displays the unit's special power as a deficit (Total Special Power - Current Special Power = -Deficit)",
	},
	["classpower:percent"] = {
		category = "Classpower",
		description = "Displays the unit's current amount of special power as a percentage",
	},
	...
	["classificationcolor"] = {
		category = "Colors",
		description = "Changes the text color, depending on the unit's classification",
	},
	["classpowercolor"] = {
		category = "Colors",
		description = "Changes the color of the special power based upon its type",
	},
	["difficulty"] = {
		category = "Colors",
	...
	["healthcolor"] = {
		category = "Colors",
		description = "Changes the text color, depending on the unit's current health",
	},
	["selectioncolor"] = {
		category = "Colors",
		description = "Colors the text, depending on the type of the unit's selection",
	},
	["classcolor"] = {
		category = "Colors",
		description = "Colors names by player class or NPC reaction (Ex: [classcolor][name])",
	},
	...
	["happiness:color"] = {
		category = "Colors",
		description = "Changes the text color, depending on the pet happiness",
	},
	-- Guild
	...
	["health:current-max-nostatus:shortvalue"] = {
		category = "Health",
		description = "Shortvalue of the unit's current and max health, without status",
	},
	...
	["health:current-max-percent-nostatus:shortvalue"] = {
		category = "Health",
		description = "Shortvalue of current and max hp (% when not full hp, without status)",
	},
	...
	["health:current-max-percent:shortvalue"] = {
		category = "Health",
		description = "Shortvalue of current and max hp (% when not full hp)",
	},
	["health:current-max-percent"] = {
		category = "Health",
		description = "Displays the current and max hp of the unit, separated by a dash (% when not full hp)",
	},
	["health:current-max:shortvalue"] = {
		category = "Health",
		description = "Shortvalue of the unit's current and max hp, separated by a dash",
	},
	["health:current-max"] = {
		category = "Health",
		description = "Displays the current and maximum health of the unit, separated by a dash",
	},
	["health:current-nostatus:shortvalue"] = {
		category = "Health",
		description = "Shortvalue of the unit's current health without status",
	},
	["health:current-nostatus"] = {
		category = "Health",
		description = "Displays the current health of the unit, without status",
	},
	["health:current-percent-nostatus:shortvalue"] = {
		category = "Health",
		description = "Shortvalue of the unit's current hp (% when not full hp), without status",
	},
	...
	["health:current-percent:shortvalue"] = {
		category = "Health",
		description = "Shortvalue of the unit's current hp (% when not full hp)",
	},
	...
	["health:current:shortvalue"] = {
		category = "Health",
		description = "Shortvalue of the unit's current health (e.g. 81k instead of 81200)",
	},
	["health:current"] = { category = "Health", description = "Displays the current health of the unit" },
	["health:deficit-nostatus:shortvalue"] = {
		category = "Health",
		description = "Shortvalue of the health deficit, without status",
	},
	...
	["health:deficit-percent:nostatus"] = {
		category = "Health",
		description = "Displays the health deficit as a percentage, without status",
	},
	["health:deficit:shortvalue"] = {
		category = "Health",
		description = "Shortvalue of the health deficit (e.g. -41k instead of -41300)",
	},
	["health:deficit"] = {
		category = "Health",
	...
	["happiness:icon"] = {
		category = "Hunter",
		description = "Displays the pet happiness like the default Blizzard icon",
	},
	-- Level
	...
	-- Mana
	["additionalmana:current-max-percent"] = {
		category = "Mana",
		description = "Displays the current and max additional mana of the unit, separated by a dash (% when not full)",
	},
	["additionalmana:current-max"] = {
		category = "Mana",
		description = "Displays the unit's current and maximum additional mana, separated by a dash",
	},
	["additionalmana:current-percent"] = {
		category = "Mana",
		description = "Displays the current additional mana of the unit and % when not full",
	},
	["additionalmana:current"] = { category = "Mana", description = "Displays the unit's current additional mana" },
	["additionalmana:deficit"] = {
		category = "Mana",
		description = "Displays the player's additional mana as a deficit",
	},
	["additionalmana:percent"] = {
		category = "Mana",
		description = "Displays the player's additional mana as a percentage",
	},
	...
	["mana:current-max-percent"] = {
		category = "Mana",
		description = "Displays the current and max mana of the unit, separated by a dash (% when not full)",
	},
	["mana:current-max"] = {
		category = "Mana",
		description = "Displays the unit's current and maximum mana, separated by a dash",
	},
	["mana:current-percent"] = {
		category = "Mana",
		description = "Displays the current mana of the unit and % when not full",
	},
	...
	["npctitle:brackets"] = {
		category = "Names",
		description = "Displays the NPC title with brackets (e.g. <General Goods Vendor>)",
	},
	...
	["group:raid"] = {
		...
		description = "Displays the group number the unit is in (1-8): Only while in a raid.",
	},
	...
	["power:current-max-percent:shortvalue"] = {
		category = "Power",
		description = "Shortvalue of the current power and max power, separated by a dash (% when not full power)",
	},
	["power:current-max-percent"] = {
		category = "Power",
		description = "Displays the current power and max power, separated by a dash (% when not full power)",
	},
	["power:current-max:shortvalue"] = {
		category = "Power",
		description = "Shortvalue of the current power and max power, separated by a dash",
	},
	["power:current-max"] = {
		category = "Power",
	...
	["power:current-percent:shortvalue"] = {
		category = "Power",
		description = "Shortvalue of the current power and power as a percentage, separated by a dash",
	},
	...
	["power:current:shortvalue"] = {
		category = "Power",
		description = "Shortvalue of the unit's current amount of power (e.g. 4k instead of 4000)",
	},
	["power:current"] = { category = "Power", description = "Displays the unit's current amount of power" },
	["power:deficit:shortvalue"] = {
		category = "Power",
		description = "Shortvalue of the power as a deficit (Total Power - Current Power = -Deficit)",
	},
	["power:deficit"] = {
		category = "Power",
	...
	["target:abbrev:long"] = {
		category = "Target",
		description = "Displays the name of the unit's target with abbreviation (limited to 20 letters)",
	},
	["target:abbrev:medium"] = {
		category = "Target",
		description = "Displays the name of the unit's target with abbreviation (limited to 15 letters)",
	},
	["target:abbrev:short"] = {
		category = "Target",
		description = "Displays the name of the unit's target with abbreviation (limited to 10 letters)",
	},
	["target:abbrev:veryshort"] = {
		category = "Target",
		description = "Displays the name of the unit's target with abbreviation (limited to 5 letters)",
	},
	["target:abbrev"] = {
		category = "Target",
		description = "Displays the name of the unit's target with abbreviation (e.g. 'Shadowfury Witch Doctor' becomes 'S. W. Doctor')",
	},
