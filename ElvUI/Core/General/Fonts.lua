...
function E:UpdateBlizzardFonts()
	...
	local size, style, blizz, noscale =
		E.db.general.fontSize, E.db.general.fontStyle, db.blizzardFontSize, db.noFontScale
	...
	if
		...
		and (
			...
			or lastFont.size ~= size
			or lastFont.style ~= style
			or lastFont.blizz ~= blizz
			or lastFont.noscale ~= noscale
		)
	then
		...
		E:SetFont(
			...
			NORMAL,
			(blizz and 22) or unscale or large,
			"SHADOW",
			0.49,
			0.35,
			0.05,
