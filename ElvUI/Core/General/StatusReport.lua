...
function E:CreateStatusFrame()
	...
	titleLogoFrame:SetScript("OnDragStart", function()
		StatusFrame:StartMoving()
		StatusFrame:SetUserPlaced(false)
	end)
	titleLogoFrame:SetScript("OnDragStop", function()
		StatusFrame:StopMovingOrSizing()
	end)
	...
	StatusFrame.Section2 =
		E:CreateStatusSection(300, 150, nil, 30, StatusFrame, "TOP", StatusFrame.Section1, "BOTTOM", 0)
	StatusFrame.Section3 =
		E:CreateStatusSection(300, 185, nil, 30, StatusFrame, "TOP", StatusFrame.Section2, "BOTTOM", 0)
...
function E:UpdateStatusFrame()
	...
	StatusFrame.Section1.Content.Line1.Text:SetFormattedText(
		"Version of ElvUI: |cff%s%.2f|r",
		(E.recievedOutOfDateMessage and "ff3333") or (E.updateRequestTriggered and "ff9933") or "33ff33",
		E.version
	)

	local addons, bugs, plugins = E:AreOtherAddOnsEnabled()
	StatusFrame.Section1.Content.Line2.Text:SetFormattedText(
		"Other AddOns Enabled: |cff%s|r",
		(not addons and not plugins and bugs and "33ff33Debug")
			or (not addons and plugins and "ff9933Plugins")
			or (addons and "ff3333Yes")
			or "33ff33No"
	)
	...
	if plugins then
		...
		if next(pluginData) then
			...
			PluginSection.Content =
				E:CreateStatusContent(count, width, PluginSection, PluginSection.Header, PluginSection.Content)
	...
	Section2.Content.Line5.Text:SetFormattedText(
		"HD Interface Patch: |cff%s|r",
		not E:IsHDPatch() and "33ff33No" or "ff3333Yes"
	)
