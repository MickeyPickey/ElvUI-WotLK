...
local function OnEvent(self)
	...
	local zone = db.showZone
			and ((mapInfo.subZoneText == mapInfo.zoneText and mapInfo.realZoneText) or mapInfo.zoneText)
		or ""
...
DT:RegisterDatatext(
	"Location",
	nil,
	{ "LOADING_SCREEN_DISABLED", "ZONE_CHANGED_NEW_AREA", "ZONE_CHANGED_INDOORS", "ZONE_CHANGED" },
	OnEvent,
	nil,
	OnClick,
	nil,
