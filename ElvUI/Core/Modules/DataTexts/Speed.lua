...
local function OnEnter()
	...
	DT.tooltip:AddDoubleLine(
		HIGHLIGHT_FONT_COLOR_CODE
			.. format(PAPERDOLLFRAME_TOOLTIP_FORMAT, SPEED)
			.. " "
			.. format("%.2f%%", UnitAttackSpeed("player"))
	...
	DT.tooltip:AddLine(
		format(
			CR_SPEED_TOOLTIP,
			BreakUpLargeNumbers(GetCombatRating(CR_HIT_TAKEN_SPELL)),
			GetCombatRatingBonus(CR_HIT_TAKEN_SPELL)
		),
		nil,
		nil,
		nil,
