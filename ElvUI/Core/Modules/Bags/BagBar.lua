...
function B:SkinBag(bag)
	...
	if icon then
		icon:SetInside()
		icon:SetTexture(
			(not bag.oldTex or bag.oldTex == [[Interface\MainMenuBar\UI-MainMenuBar-Dwarf]])
					and E.Media.Textures.Backpack
				or bag.oldTex
		)
		icon:SetTexCoords()
	end
...
function B:SizeAndPositionBagBar()
	...
	B.BagBar.backdrop:Point(
		"BOTTOMRIGHT",
		justBackpack and firstButton or lastButton,
		"BOTTOMRIGHT",
		backdropSpacing,
		-backdropSpacing
	)
...
function B:LoadBagBar()
	...
	_G.MainMenuBarBackpackButtonCount:FontTemplate(
		LSM:Fetch("font", B.BagBar.db.font),
		B.BagBar.db.fontSize,
		B.BagBar.db.fontOutline
	)
