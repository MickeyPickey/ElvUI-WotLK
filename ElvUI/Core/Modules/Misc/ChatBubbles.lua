...
local function SetFontTemplate(name, db)
	if db and db.replaceBubbleFont then
		local font, size, outline =
			LSM:Fetch("font", db.chatBubbleFont), db.chatBubbleFontSize, db.chatBubbleFontOutline
...
function M:LoadChatBubbles()
	yOffset = (E.private.general.chatBubbles == "backdrop" and 2)
		or (E.private.general.chatBubbles == "backdrop_noborder" and -2)
		or 0
